...
# How to Run
To execute the code, simply run the main method and input the text file name i.e. "input.txt" as well as its directory path and press enter. The output will be displayed through the console.
